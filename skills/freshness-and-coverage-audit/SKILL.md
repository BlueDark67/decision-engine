...
description: Assess whether available inputs are fresh enough and whether the coverage environment supports the planned reasoning. Use for time-sensitive betting analysis, especially football coverage mode decisions and late NBA or F1 updates.
---

# Freshness And Coverage Audit

Read `../../core/input-standard.md`, `../../core/data-quality.md`, `../../sports/football/coverage-modes.md`, and `../../sports/f1/modes.md` when relevant.
